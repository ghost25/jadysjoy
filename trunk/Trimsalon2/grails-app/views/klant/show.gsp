        ...
        <div class="body">
            ...
            <div class="dialog">
                    ...
                    <tbody>             
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="klant.telefoon.label" default="Mobiel" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: klantInstance, field: "telefoon2")}</td>
